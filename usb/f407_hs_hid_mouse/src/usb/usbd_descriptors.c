...
const USB_DEVICE_DESC_t Device_Descriptor = {
    ...
    .bMaxPacketSize0    = 8,
    .idVendor           = 0x6666, // for prototype products
    .idProduct          = 0x13AA, // random value
    .bcdDevice          = 0x0100, // product version 1.00
    .iManufacturer      = 0, // no manufacturer string
    .iProduct           = 0, // no product string
    .iSerialNumber      = 0, // no serial id string
...
const USB_CONFIG_DESC_SET_t Config_Desc_Set = {
	.config_desc = {
		...
		.bmAttributes           = 0x80 | 0x40, // b7 reserved = 1 : b6 = 1 => self-powered, b5 = 0: no remote wakeup support
